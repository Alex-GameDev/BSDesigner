...
namespace BSDesigner.Unity.Assets.Runtime
{
    /// <summary>
    /// Action type specified for Unity Environment
    /// </summary>
    public abstract class UnityConditionTask : PerceptionTask
    {
        /// <summary>
        ...
        public sealed override void SetContext(ExecutionContext context)
        {
